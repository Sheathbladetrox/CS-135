...
(define (wj-help fillA fillB maxA maxB goal)
  (cond
    [(= fillB goal)(list(list fillA fillB))]
    [(= fillB maxB)(cons(list fillA fillB)(wj-help fillA 0 maxA maxB goal))]
    [(= fillA 0)(cons(list fillA fillB)(wj-help maxA fillB maxA maxB goal))]
    [(> (+ fillA fillB) maxB)(cons(list fillA fillB)(wj-help (- (+ fillA fillB) maxB) maxB maxA maxB goal))]
